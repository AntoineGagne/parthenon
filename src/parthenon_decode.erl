...
-spec encode_key(
    binary(),
    parthenon_schema:schema_object() | parthenon_schema:schema_map(),
    decode_options()
) ->
    binary() | parthenon_schema:primitive_types().
...
-spec value_encoder(
    ...
    parthenon_schema:schema() | Default.
